...
cell, it could envelope the ribosome \cite{Kong:1999}. As yet 
...
\begin{figure}[ht]
  \includegraphics[width=0.5\textwidth]{figures/miRNA.pdf}
  \includegraphics[width=0.45\textwidth]{figures/snoRNA.pdf}
  \caption[]{.}\label{fig:3}
\end{figure}
