...
The CM based approach works well for most classes of ncRNA, but the
long non-coding RNAs (lncRNAs) are a particular challenge
...
\cite{Burge:2013}. Whilst some these regions may not reflect
functional RNA elements instead regulatory regions, enhancers or
insulators, their syntenic conservation still provides an indication
of lncRNA conservation \cite{diederichs2014four}. 
