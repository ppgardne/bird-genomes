...
\begin{figure}[ht]
  \includegraphics[width=0.85\textwidth]{figures/Y.pdf}
  \caption[]{...}\label{fig:6}
\end{figure}

\begin{figure}[ht]
  \includegraphics[width=0.85\textwidth]{figures/mir-17-cluster.pdf}
  \caption[]{...}\label{fig:8}
\end{figure}

\begin{figure}[ht]
  \includegraphics[width=0.85\textwidth]{figures/let-7-cluster.pdf}
  \caption[]{...}\label{fig:9}
\end{figure}
